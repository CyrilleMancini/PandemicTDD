...
namespace PandemicTDDTests.Initialization
{
    ...
    public class StartingGame : TestsBase
    {
        ...
        public void InitPlayersMax4Players()
        {
            ...
            {
                GameState gameState = new(Players, GameBox);
                gameState.StartGame();
            });
        }
        ...
        public void InitPlayersMin2Players()
        {
            ...
            {
                GameState gameState = new(Players.GetRange(0, 1), GameBox);
                gameState.StartGame();
            });
        }
        ...
        {
            GameState gameState = new(Players.GetRange(0, 4), GameBox);
            gameState.StartGame();
        ...
        public void DistibutesPlayerCard2Players()
        {
            ...
            GameState gameState = new(Players.GetRange(0, 2), GameBox);
            gameState.StartGame();
